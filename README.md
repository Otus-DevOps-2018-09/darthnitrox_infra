...
# Ansible-4  
Был описан конфиг vagrant для поднятия виртуального окружения для тестирования ролей. Был написан тест для проверки поднялся ли порт послзе запуска mongodb. Был добавлен  playbook для установки python если он отсутсвует.
